...
# Part 3: Your topic  
Choose a topic of sociological (or social scientific) interest from your own interests or from those listed under “Final Project Data” on the "Final Project" part of the course webpage and identify a focal relationship related to this topic that you would like to study. Make sure to choose a dependent variable measured at the interval level (either discrete or continuous).
...
3.2 Identify at least one variable in the dataset that might be used to measure your focal independent variable and one for the dependent variable? Name the variables you’ve selected and indicate their levels of measurement.  